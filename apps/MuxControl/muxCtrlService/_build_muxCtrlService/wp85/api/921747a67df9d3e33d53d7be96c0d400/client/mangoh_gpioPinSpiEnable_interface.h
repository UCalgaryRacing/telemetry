...
#ifndef MANGOH_GPIOPINSPIENABLE_INTERFACE_H_INCLUDE_GUARD
#define MANGOH_GPIOPINSPIENABLE_INTERFACE_H_INCLUDE_GUARD
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*mangoh_gpioPinSpiEnable_DisconnectHandler_t)(void *);
...
typedef enum
{
    MANGOH_GPIOPINSPIENABLE_ACTIVE_HIGH = 0,
        ///< GPIO active-high, output is 1
    MANGOH_GPIOPINSPIENABLE_ACTIVE_LOW = 1
        ///< GPIO active-low, output is 0
}
mangoh_gpioPinSpiEnable_Polarity_t;
...
typedef enum
{
    MANGOH_GPIOPINSPIENABLE_EDGE_NONE = 0,
        ///< No edge detection
    MANGOH_GPIOPINSPIENABLE_EDGE_RISING = 1,
        ///< Notify when voltage goes from low to high.
    MANGOH_GPIOPINSPIENABLE_EDGE_FALLING = 2,
        ///< Notify when voltage goes from high to low.
    MANGOH_GPIOPINSPIENABLE_EDGE_BOTH = 3
        ///< Notify when pin voltage changes state in either direction.
}
mangoh_gpioPinSpiEnable_Edge_t;


//--------------------------------------------------------------------------------------------------
/**
 * Reference type used by Add/Remove functions for EVENT 'mangoh_gpioPinSpiEnable_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
typedef struct mangoh_gpioPinSpiEnable_ChangeEventHandler* mangoh_gpioPinSpiEnable_ChangeEventHandlerRef_t;
...
typedef enum
{
    MANGOH_GPIOPINSPIENABLE_PULL_OFF = 0,
        ///< Neither resistor is enabled
    MANGOH_GPIOPINSPIENABLE_PULL_DOWN = 1,
        ///< Pulldown resistor is enabled
    MANGOH_GPIOPINSPIENABLE_PULL_UP = 2
        ///< Pullup resistor is enabled
}
mangoh_gpioPinSpiEnable_PullUpDown_t;
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*mangoh_gpioPinSpiEnable_ChangeCallbackFunc_t)
(
    bool state,
...
#endif // MANGOH_GPIOPINSPIENABLE_INTERFACE_H_INCLUDE_GUARD