...
#ifndef MANGOH_GPIOPINPCMANALOGSELECT_INTERFACE_H_INCLUDE_GUARD
#define MANGOH_GPIOPINPCMANALOGSELECT_INTERFACE_H_INCLUDE_GUARD
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*mangoh_gpioPinPcmAnalogSelect_DisconnectHandler_t)(void *);
...
typedef enum
{
    MANGOH_GPIOPINPCMANALOGSELECT_ACTIVE_HIGH = 0,
        ///< GPIO active-high, output is 1
    MANGOH_GPIOPINPCMANALOGSELECT_ACTIVE_LOW = 1
        ///< GPIO active-low, output is 0
}
mangoh_gpioPinPcmAnalogSelect_Polarity_t;
...
typedef enum
{
    MANGOH_GPIOPINPCMANALOGSELECT_EDGE_NONE = 0,
        ///< No edge detection
    MANGOH_GPIOPINPCMANALOGSELECT_EDGE_RISING = 1,
        ///< Notify when voltage goes from low to high.
    MANGOH_GPIOPINPCMANALOGSELECT_EDGE_FALLING = 2,
        ///< Notify when voltage goes from high to low.
    MANGOH_GPIOPINPCMANALOGSELECT_EDGE_BOTH = 3
        ///< Notify when pin voltage changes state in either direction.
}
mangoh_gpioPinPcmAnalogSelect_Edge_t;


//--------------------------------------------------------------------------------------------------
/**
 * Reference type used by Add/Remove functions for EVENT 'mangoh_gpioPinPcmAnalogSelect_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
typedef struct mangoh_gpioPinPcmAnalogSelect_ChangeEventHandler* mangoh_gpioPinPcmAnalogSelect_ChangeEventHandlerRef_t;
...
typedef enum
{
    MANGOH_GPIOPINPCMANALOGSELECT_PULL_OFF = 0,
        ///< Neither resistor is enabled
    MANGOH_GPIOPINPCMANALOGSELECT_PULL_DOWN = 1,
        ///< Pulldown resistor is enabled
    MANGOH_GPIOPINPCMANALOGSELECT_PULL_UP = 2
        ///< Pullup resistor is enabled
}
mangoh_gpioPinPcmAnalogSelect_PullUpDown_t;
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*mangoh_gpioPinPcmAnalogSelect_ChangeCallbackFunc_t)
(
    bool state,
...
#endif // MANGOH_GPIOPINPCMANALOGSELECT_INTERFACE_H_INCLUDE_GUARD