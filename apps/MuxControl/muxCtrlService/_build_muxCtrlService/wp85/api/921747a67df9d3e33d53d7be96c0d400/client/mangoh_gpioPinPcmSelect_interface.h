...
#ifndef MANGOH_GPIOPINPCMSELECT_INTERFACE_H_INCLUDE_GUARD
#define MANGOH_GPIOPINPCMSELECT_INTERFACE_H_INCLUDE_GUARD
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*mangoh_gpioPinPcmSelect_DisconnectHandler_t)(void *);
...
typedef enum
{
    MANGOH_GPIOPINPCMSELECT_ACTIVE_HIGH = 0,
        ///< GPIO active-high, output is 1
    MANGOH_GPIOPINPCMSELECT_ACTIVE_LOW = 1
        ///< GPIO active-low, output is 0
}
mangoh_gpioPinPcmSelect_Polarity_t;
...
typedef enum
{
    MANGOH_GPIOPINPCMSELECT_EDGE_NONE = 0,
        ///< No edge detection
    MANGOH_GPIOPINPCMSELECT_EDGE_RISING = 1,
        ///< Notify when voltage goes from low to high.
    MANGOH_GPIOPINPCMSELECT_EDGE_FALLING = 2,
        ///< Notify when voltage goes from high to low.
    MANGOH_GPIOPINPCMSELECT_EDGE_BOTH = 3
        ///< Notify when pin voltage changes state in either direction.
}
mangoh_gpioPinPcmSelect_Edge_t;


//--------------------------------------------------------------------------------------------------
/**
 * Reference type used by Add/Remove functions for EVENT 'mangoh_gpioPinPcmSelect_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
typedef struct mangoh_gpioPinPcmSelect_ChangeEventHandler* mangoh_gpioPinPcmSelect_ChangeEventHandlerRef_t;
...
typedef enum
{
    MANGOH_GPIOPINPCMSELECT_PULL_OFF = 0,
        ///< Neither resistor is enabled
    MANGOH_GPIOPINPCMSELECT_PULL_DOWN = 1,
        ///< Pulldown resistor is enabled
    MANGOH_GPIOPINPCMSELECT_PULL_UP = 2
        ///< Pullup resistor is enabled
}
mangoh_gpioPinPcmSelect_PullUpDown_t;
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*mangoh_gpioPinPcmSelect_ChangeCallbackFunc_t)
(
    bool state,
...
#endif // MANGOH_GPIOPINPCMSELECT_INTERFACE_H_INCLUDE_GUARD