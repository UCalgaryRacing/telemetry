...
#include "mangoh_gpioPinPcmAnalogSelect_interface.h"
#include "mangoh_gpioPinPcmAnalogSelect_messages.h"
...
typedef struct
{
    ...
    mangoh_gpioPinPcmAnalogSelect_DisconnectHandler_t disconnectHandler; ///< Disconnect handler for this thread
...
)
{
    ...
    LE_FATAL_IF(clientThreadPtr==NULL,
                "mangoh_gpioPinPcmAnalogSelect_ConnectService() not called for current thread");
...
static void InitCommonData(void)
{
    ...
    _ClientDataPool = le_mem_CreatePool("mangoh_gpioPinPcmAnalogSelect_ClientData", sizeof(_ClientData_t));

    // Allocate the client thread pool
    _ClientThreadDataPool = le_mem_CreatePool("mangoh_gpioPinPcmAnalogSelect_ClientThreadData", sizeof(_ClientThreadData_t));
    ...
    _HandlerRefMap = le_ref_CreateMap("mangoh_gpioPinPcmAnalogSelect_ClientHandlers", 5);
}
 ...
 */
//--------------------------------------------------------------------------------------------------
void mangoh_gpioPinPcmAnalogSelect_ConnectService
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t mangoh_gpioPinPcmAnalogSelect_TryConnectService
(
    void
)
{
...
)
{
    ...
    LE_FATAL("Component for mangoh_gpioPinPcmAnalogSelect disconnected\n");
}
 ...
 */
//--------------------------------------------------------------------------------------------------
void mangoh_gpioPinPcmAnalogSelect_SetServerDisconnectHandler
(
    mangoh_gpioPinPcmAnalogSelect_DisconnectHandler_t disconnectHandler,
    void *contextPtr
)
{
    _ClientThreadData_t* clientThreadPtr = GetClientThreadDataPtr();
 ...
 */
//--------------------------------------------------------------------------------------------------
void mangoh_gpioPinPcmAnalogSelect_DisconnectService
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t mangoh_gpioPinPcmAnalogSelect_SetInput
(
    mangoh_gpioPinPcmAnalogSelect_Polarity_t polarity
...
)
{
    ...
    _msgPtr->id = _MSGID_mangoh_gpioPinPcmAnalogSelect_SetInput;
    ...
    LE_ASSERT(mangoh_gpioPinPcmAnalogSelect_PackPolarity( &_msgBufPtr, &_msgBufSize,
                                                  polarity ));
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t mangoh_gpioPinPcmAnalogSelect_SetPushPullOutput
(
    mangoh_gpioPinPcmAnalogSelect_Polarity_t polarity,
        ///< [IN] Active-high or active-low.
    bool value
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinPcmAnalogSelect_SetPushPullOutput;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t mangoh_gpioPinPcmAnalogSelect_SetTriStateOutput
(
    mangoh_gpioPinPcmAnalogSelect_Polarity_t polarity
        ///< [IN] Active-high or active-low.
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinPcmAnalogSelect_SetTriStateOutput;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t mangoh_gpioPinPcmAnalogSelect_SetOpenDrainOutput
(
    mangoh_gpioPinPcmAnalogSelect_Polarity_t polarity,
        ///< [IN] Active-high or active-low.
    bool value
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinPcmAnalogSelect_SetOpenDrainOutput;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t mangoh_gpioPinPcmAnalogSelect_EnablePullUp
(
    void
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinPcmAnalogSelect_EnablePullUp;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t mangoh_gpioPinPcmAnalogSelect_EnablePullDown
(
    void
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinPcmAnalogSelect_EnablePullDown;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t mangoh_gpioPinPcmAnalogSelect_DisableResistors
(
    void
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinPcmAnalogSelect_DisableResistors;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t mangoh_gpioPinPcmAnalogSelect_Activate
(
    void
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinPcmAnalogSelect_Activate;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t mangoh_gpioPinPcmAnalogSelect_Deactivate
(
    void
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinPcmAnalogSelect_Deactivate;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t mangoh_gpioPinPcmAnalogSelect_SetHighZ
(
    void
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinPcmAnalogSelect_SetHighZ;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
 ...
 */
//--------------------------------------------------------------------------------------------------
bool mangoh_gpioPinPcmAnalogSelect_Read
(
    void
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinPcmAnalogSelect_Read;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
...
static void _Handle_mangoh_gpioPinPcmAnalogSelect_AddChangeEventHandler
(
    void* _reportPtr,
    void* _dataPtr
)
{
    ...
    mangoh_gpioPinPcmAnalogSelect_ChangeCallbackFunc_t _handlerRef_mangoh_gpioPinPcmAnalogSelect_AddChangeEventHandler = (mangoh_gpioPinPcmAnalogSelect_ChangeCallbackFunc_t)_clientDataPtr->handlerPtr;
    ...
    if ( _handlerRef_mangoh_gpioPinPcmAnalogSelect_AddChangeEventHandler != NULL )
    {
        _handlerRef_mangoh_gpioPinPcmAnalogSelect_AddChangeEventHandler(state, contextPtr );
    }
    else
    {
...
//--------------------------------------------------------------------------------------------------
/**
 * Add handler function for EVENT 'mangoh_gpioPinPcmAnalogSelect_ChangeEvent'
 *
 ...
 */
//--------------------------------------------------------------------------------------------------
mangoh_gpioPinPcmAnalogSelect_ChangeEventHandlerRef_t mangoh_gpioPinPcmAnalogSelect_AddChangeEventHandler
(
    mangoh_gpioPinPcmAnalogSelect_Edge_t trigger,
        ///< [IN] Change(s) that should trigger the callback to be called.
    mangoh_gpioPinPcmAnalogSelect_ChangeCallbackFunc_t handlerPtr,
...
)
{
    ...
    mangoh_gpioPinPcmAnalogSelect_ChangeEventHandlerRef_t _result;
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinPcmAnalogSelect_AddChangeEventHandler;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
    ...
    // Pack the input parameters
    LE_ASSERT(mangoh_gpioPinPcmAnalogSelect_PackEdge( &_msgBufPtr, &_msgBufSize,
                                                  trigger ));
...
//--------------------------------------------------------------------------------------------------
/**
 * Remove handler function for EVENT 'mangoh_gpioPinPcmAnalogSelect_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
void mangoh_gpioPinPcmAnalogSelect_RemoveChangeEventHandler
(
    mangoh_gpioPinPcmAnalogSelect_ChangeEventHandlerRef_t handlerRef
        ///< [IN]
)
{
    le_msg_MessageRef_t _msgRef;
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinPcmAnalogSelect_RemoveChangeEventHandler;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
    ...
    _UNLOCK
    handlerRef = (mangoh_gpioPinPcmAnalogSelect_ChangeEventHandlerRef_t)clientDataPtr->handlerRef;
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t mangoh_gpioPinPcmAnalogSelect_SetEdgeSense
(
    mangoh_gpioPinPcmAnalogSelect_Edge_t trigger
        ///< [IN] Change(s) that should trigger the callback to be called.
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinPcmAnalogSelect_SetEdgeSense;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t mangoh_gpioPinPcmAnalogSelect_DisableEdgeSense
(
    void
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinPcmAnalogSelect_DisableEdgeSense;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
 ...
 */
//--------------------------------------------------------------------------------------------------
bool mangoh_gpioPinPcmAnalogSelect_IsOutput
(
    void
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinPcmAnalogSelect_IsOutput;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
 ...
 */
//--------------------------------------------------------------------------------------------------
bool mangoh_gpioPinPcmAnalogSelect_IsInput
(
    void
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinPcmAnalogSelect_IsInput;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
 ...
 */
//--------------------------------------------------------------------------------------------------
mangoh_gpioPinPcmAnalogSelect_Edge_t mangoh_gpioPinPcmAnalogSelect_GetEdgeSense
(
    void
)
{
    ...
    mangoh_gpioPinPcmAnalogSelect_Edge_t _result;
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinPcmAnalogSelect_GetEdgeSense;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
    ...
    // Unpack the result first
    if (!mangoh_gpioPinPcmAnalogSelect_UnpackEdge( &_msgBufPtr, &_msgBufSize, &_result ))
    {
        goto error_unpack;
    }
 ...
 */
//--------------------------------------------------------------------------------------------------
mangoh_gpioPinPcmAnalogSelect_Polarity_t mangoh_gpioPinPcmAnalogSelect_GetPolarity
(
    void
)
{
    ...
    mangoh_gpioPinPcmAnalogSelect_Polarity_t _result;
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinPcmAnalogSelect_GetPolarity;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
    ...
    // Unpack the result first
    if (!mangoh_gpioPinPcmAnalogSelect_UnpackPolarity( &_msgBufPtr, &_msgBufSize, &_result ))
    {
        goto error_unpack;
    }
 ...
 */
//--------------------------------------------------------------------------------------------------
bool mangoh_gpioPinPcmAnalogSelect_IsActive
(
    void
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinPcmAnalogSelect_IsActive;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
 ...
 */
//--------------------------------------------------------------------------------------------------
mangoh_gpioPinPcmAnalogSelect_PullUpDown_t mangoh_gpioPinPcmAnalogSelect_GetPullUpDown
(
    void
)
{
    ...
    mangoh_gpioPinPcmAnalogSelect_PullUpDown_t _result;
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinPcmAnalogSelect_GetPullUpDown;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
    ...
    // Unpack the result first
    if (!mangoh_gpioPinPcmAnalogSelect_UnpackPullUpDown( &_msgBufPtr, &_msgBufSize, &_result ))
    {
        goto error_unpack;
    }
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_mangoh_gpioPinPcmAnalogSelect_AddChangeEventHandler :
            le_event_QueueFunctionToThread(callersThreadRef, _Handle_mangoh_gpioPinPcmAnalogSelect_AddChangeEventHandler, msgRef, clientDataPtr);
            break;
