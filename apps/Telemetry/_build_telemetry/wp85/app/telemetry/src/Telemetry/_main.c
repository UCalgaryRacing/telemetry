...
// Startup code for the executable 'Telemetry'.
...
LE_SHARED le_log_SessionRef_t Telemetry_exe_LogSession;
LE_SHARED le_log_Level_t* Telemetry_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    Telemetry_exe_LogSession = log_RegComponent("Telemetry_exe", &Telemetry_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_Sender.so");
