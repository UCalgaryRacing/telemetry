...
#ifndef MANGOH_GPIOPINPCMENABLE_INTERFACE_H_INCLUDE_GUARD
#define MANGOH_GPIOPINPCMENABLE_INTERFACE_H_INCLUDE_GUARD
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*mangoh_gpioPinPcmEnable_DisconnectHandler_t)(void *);
...
typedef enum
{
    MANGOH_GPIOPINPCMENABLE_ACTIVE_HIGH = 0,
        ///< GPIO active-high, output is 1
    MANGOH_GPIOPINPCMENABLE_ACTIVE_LOW = 1
        ///< GPIO active-low, output is 0
}
mangoh_gpioPinPcmEnable_Polarity_t;
...
typedef enum
{
    MANGOH_GPIOPINPCMENABLE_EDGE_NONE = 0,
        ///< No edge detection
    MANGOH_GPIOPINPCMENABLE_EDGE_RISING = 1,
        ///< Notify when voltage goes from low to high.
    MANGOH_GPIOPINPCMENABLE_EDGE_FALLING = 2,
        ///< Notify when voltage goes from high to low.
    MANGOH_GPIOPINPCMENABLE_EDGE_BOTH = 3
        ///< Notify when pin voltage changes state in either direction.
}
mangoh_gpioPinPcmEnable_Edge_t;


//--------------------------------------------------------------------------------------------------
/**
 * Reference type used by Add/Remove functions for EVENT 'mangoh_gpioPinPcmEnable_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
typedef struct mangoh_gpioPinPcmEnable_ChangeEventHandler* mangoh_gpioPinPcmEnable_ChangeEventHandlerRef_t;
...
typedef enum
{
    MANGOH_GPIOPINPCMENABLE_PULL_OFF = 0,
        ///< Neither resistor is enabled
    MANGOH_GPIOPINPCMENABLE_PULL_DOWN = 1,
        ///< Pulldown resistor is enabled
    MANGOH_GPIOPINPCMENABLE_PULL_UP = 2
        ///< Pullup resistor is enabled
}
mangoh_gpioPinPcmEnable_PullUpDown_t;
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*mangoh_gpioPinPcmEnable_ChangeCallbackFunc_t)
(
    bool state,
...
#endif // MANGOH_GPIOPINPCMENABLE_INTERFACE_H_INCLUDE_GUARD