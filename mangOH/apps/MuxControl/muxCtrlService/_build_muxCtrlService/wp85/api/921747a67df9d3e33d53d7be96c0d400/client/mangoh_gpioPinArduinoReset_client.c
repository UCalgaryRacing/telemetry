...
#include "mangoh_gpioPinArduinoReset_interface.h"
#include "mangoh_gpioPinArduinoReset_messages.h"
...
typedef struct
{
    ...
    mangoh_gpioPinArduinoReset_DisconnectHandler_t disconnectHandler; ///< Disconnect handler for this thread
...
)
{
    ...
    LE_FATAL_IF(clientThreadPtr==NULL,
                "mangoh_gpioPinArduinoReset_ConnectService() not called for current thread");
...
static void InitCommonData(void)
{
    ...
    _ClientDataPool = le_mem_CreatePool("mangoh_gpioPinArduinoReset_ClientData", sizeof(_ClientData_t));

    // Allocate the client thread pool
    _ClientThreadDataPool = le_mem_CreatePool("mangoh_gpioPinArduinoReset_ClientThreadData", sizeof(_ClientThreadData_t));
    ...
    _HandlerRefMap = le_ref_CreateMap("mangoh_gpioPinArduinoReset_ClientHandlers", 5);
}
 ...
 */
//--------------------------------------------------------------------------------------------------
void mangoh_gpioPinArduinoReset_ConnectService
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t mangoh_gpioPinArduinoReset_TryConnectService
(
    void
)
{
...
)
{
    ...
    LE_FATAL("Component for mangoh_gpioPinArduinoReset disconnected\n");
}
 ...
 */
//--------------------------------------------------------------------------------------------------
void mangoh_gpioPinArduinoReset_SetServerDisconnectHandler
(
    mangoh_gpioPinArduinoReset_DisconnectHandler_t disconnectHandler,
    void *contextPtr
)
{
    _ClientThreadData_t* clientThreadPtr = GetClientThreadDataPtr();
 ...
 */
//--------------------------------------------------------------------------------------------------
void mangoh_gpioPinArduinoReset_DisconnectService
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t mangoh_gpioPinArduinoReset_SetInput
(
    mangoh_gpioPinArduinoReset_Polarity_t polarity
...
)
{
    ...
    _msgPtr->id = _MSGID_mangoh_gpioPinArduinoReset_SetInput;
    ...
    LE_ASSERT(mangoh_gpioPinArduinoReset_PackPolarity( &_msgBufPtr, &_msgBufSize,
                                                  polarity ));
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t mangoh_gpioPinArduinoReset_SetPushPullOutput
(
    mangoh_gpioPinArduinoReset_Polarity_t polarity,
        ///< [IN] Active-high or active-low.
    bool value
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinArduinoReset_SetPushPullOutput;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t mangoh_gpioPinArduinoReset_SetTriStateOutput
(
    mangoh_gpioPinArduinoReset_Polarity_t polarity
        ///< [IN] Active-high or active-low.
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinArduinoReset_SetTriStateOutput;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t mangoh_gpioPinArduinoReset_SetOpenDrainOutput
(
    mangoh_gpioPinArduinoReset_Polarity_t polarity,
        ///< [IN] Active-high or active-low.
    bool value
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinArduinoReset_SetOpenDrainOutput;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t mangoh_gpioPinArduinoReset_EnablePullUp
(
    void
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinArduinoReset_EnablePullUp;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t mangoh_gpioPinArduinoReset_EnablePullDown
(
    void
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinArduinoReset_EnablePullDown;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t mangoh_gpioPinArduinoReset_DisableResistors
(
    void
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinArduinoReset_DisableResistors;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t mangoh_gpioPinArduinoReset_Activate
(
    void
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinArduinoReset_Activate;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t mangoh_gpioPinArduinoReset_Deactivate
(
    void
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinArduinoReset_Deactivate;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t mangoh_gpioPinArduinoReset_SetHighZ
(
    void
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinArduinoReset_SetHighZ;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
 ...
 */
//--------------------------------------------------------------------------------------------------
bool mangoh_gpioPinArduinoReset_Read
(
    void
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinArduinoReset_Read;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
...
static void _Handle_mangoh_gpioPinArduinoReset_AddChangeEventHandler
(
    void* _reportPtr,
    void* _dataPtr
)
{
    ...
    mangoh_gpioPinArduinoReset_ChangeCallbackFunc_t _handlerRef_mangoh_gpioPinArduinoReset_AddChangeEventHandler = (mangoh_gpioPinArduinoReset_ChangeCallbackFunc_t)_clientDataPtr->handlerPtr;
    ...
    if ( _handlerRef_mangoh_gpioPinArduinoReset_AddChangeEventHandler != NULL )
    {
        _handlerRef_mangoh_gpioPinArduinoReset_AddChangeEventHandler(state, contextPtr );
    }
    else
    {
...
//--------------------------------------------------------------------------------------------------
/**
 * Add handler function for EVENT 'mangoh_gpioPinArduinoReset_ChangeEvent'
 *
 ...
 */
//--------------------------------------------------------------------------------------------------
mangoh_gpioPinArduinoReset_ChangeEventHandlerRef_t mangoh_gpioPinArduinoReset_AddChangeEventHandler
(
    mangoh_gpioPinArduinoReset_Edge_t trigger,
        ///< [IN] Change(s) that should trigger the callback to be called.
    mangoh_gpioPinArduinoReset_ChangeCallbackFunc_t handlerPtr,
...
)
{
    ...
    mangoh_gpioPinArduinoReset_ChangeEventHandlerRef_t _result;
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinArduinoReset_AddChangeEventHandler;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
    ...
    // Pack the input parameters
    LE_ASSERT(mangoh_gpioPinArduinoReset_PackEdge( &_msgBufPtr, &_msgBufSize,
                                                  trigger ));
...
//--------------------------------------------------------------------------------------------------
/**
 * Remove handler function for EVENT 'mangoh_gpioPinArduinoReset_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
void mangoh_gpioPinArduinoReset_RemoveChangeEventHandler
(
    mangoh_gpioPinArduinoReset_ChangeEventHandlerRef_t handlerRef
        ///< [IN]
)
{
    le_msg_MessageRef_t _msgRef;
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinArduinoReset_RemoveChangeEventHandler;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
    ...
    _UNLOCK
    handlerRef = (mangoh_gpioPinArduinoReset_ChangeEventHandlerRef_t)clientDataPtr->handlerRef;
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t mangoh_gpioPinArduinoReset_SetEdgeSense
(
    mangoh_gpioPinArduinoReset_Edge_t trigger
        ///< [IN] Change(s) that should trigger the callback to be called.
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinArduinoReset_SetEdgeSense;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t mangoh_gpioPinArduinoReset_DisableEdgeSense
(
    void
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinArduinoReset_DisableEdgeSense;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
 ...
 */
//--------------------------------------------------------------------------------------------------
bool mangoh_gpioPinArduinoReset_IsOutput
(
    void
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinArduinoReset_IsOutput;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
 ...
 */
//--------------------------------------------------------------------------------------------------
bool mangoh_gpioPinArduinoReset_IsInput
(
    void
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinArduinoReset_IsInput;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
 ...
 */
//--------------------------------------------------------------------------------------------------
mangoh_gpioPinArduinoReset_Edge_t mangoh_gpioPinArduinoReset_GetEdgeSense
(
    void
)
{
    ...
    mangoh_gpioPinArduinoReset_Edge_t _result;
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinArduinoReset_GetEdgeSense;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
    ...
    // Unpack the result first
    if (!mangoh_gpioPinArduinoReset_UnpackEdge( &_msgBufPtr, &_msgBufSize, &_result ))
    {
        goto error_unpack;
    }
 ...
 */
//--------------------------------------------------------------------------------------------------
mangoh_gpioPinArduinoReset_Polarity_t mangoh_gpioPinArduinoReset_GetPolarity
(
    void
)
{
    ...
    mangoh_gpioPinArduinoReset_Polarity_t _result;
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinArduinoReset_GetPolarity;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
    ...
    // Unpack the result first
    if (!mangoh_gpioPinArduinoReset_UnpackPolarity( &_msgBufPtr, &_msgBufSize, &_result ))
    {
        goto error_unpack;
    }
 ...
 */
//--------------------------------------------------------------------------------------------------
bool mangoh_gpioPinArduinoReset_IsActive
(
    void
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinArduinoReset_IsActive;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
 ...
 */
//--------------------------------------------------------------------------------------------------
mangoh_gpioPinArduinoReset_PullUpDown_t mangoh_gpioPinArduinoReset_GetPullUpDown
(
    void
)
{
    ...
    mangoh_gpioPinArduinoReset_PullUpDown_t _result;
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinArduinoReset_GetPullUpDown;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
    ...
    // Unpack the result first
    if (!mangoh_gpioPinArduinoReset_UnpackPullUpDown( &_msgBufPtr, &_msgBufSize, &_result ))
    {
        goto error_unpack;
    }
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_mangoh_gpioPinArduinoReset_AddChangeEventHandler :
            le_event_QueueFunctionToThread(callersThreadRef, _Handle_mangoh_gpioPinArduinoReset_AddChangeEventHandler, msgRef, clientDataPtr);
            break;
