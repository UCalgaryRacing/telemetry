...
#ifndef MANGOH_GPIOPINUART2SELECT_INTERFACE_H_INCLUDE_GUARD
#define MANGOH_GPIOPINUART2SELECT_INTERFACE_H_INCLUDE_GUARD
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*mangoh_gpioPinUart2Select_DisconnectHandler_t)(void *);
...
typedef enum
{
    MANGOH_GPIOPINUART2SELECT_ACTIVE_HIGH = 0,
        ///< GPIO active-high, output is 1
    MANGOH_GPIOPINUART2SELECT_ACTIVE_LOW = 1
        ///< GPIO active-low, output is 0
}
mangoh_gpioPinUart2Select_Polarity_t;
...
typedef enum
{
    MANGOH_GPIOPINUART2SELECT_EDGE_NONE = 0,
        ///< No edge detection
    MANGOH_GPIOPINUART2SELECT_EDGE_RISING = 1,
        ///< Notify when voltage goes from low to high.
    MANGOH_GPIOPINUART2SELECT_EDGE_FALLING = 2,
        ///< Notify when voltage goes from high to low.
    MANGOH_GPIOPINUART2SELECT_EDGE_BOTH = 3
        ///< Notify when pin voltage changes state in either direction.
}
mangoh_gpioPinUart2Select_Edge_t;


//--------------------------------------------------------------------------------------------------
/**
 * Reference type used by Add/Remove functions for EVENT 'mangoh_gpioPinUart2Select_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
typedef struct mangoh_gpioPinUart2Select_ChangeEventHandler* mangoh_gpioPinUart2Select_ChangeEventHandlerRef_t;
...
typedef enum
{
    MANGOH_GPIOPINUART2SELECT_PULL_OFF = 0,
        ///< Neither resistor is enabled
    MANGOH_GPIOPINUART2SELECT_PULL_DOWN = 1,
        ///< Pulldown resistor is enabled
    MANGOH_GPIOPINUART2SELECT_PULL_UP = 2
        ///< Pullup resistor is enabled
}
mangoh_gpioPinUart2Select_PullUpDown_t;
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*mangoh_gpioPinUart2Select_ChangeCallbackFunc_t)
(
    bool state,
...
#endif // MANGOH_GPIOPINUART2SELECT_INTERFACE_H_INCLUDE_GUARD