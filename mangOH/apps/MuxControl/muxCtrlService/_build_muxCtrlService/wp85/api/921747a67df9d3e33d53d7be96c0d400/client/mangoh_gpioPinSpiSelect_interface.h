...
#ifndef MANGOH_GPIOPINSPISELECT_INTERFACE_H_INCLUDE_GUARD
#define MANGOH_GPIOPINSPISELECT_INTERFACE_H_INCLUDE_GUARD
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*mangoh_gpioPinSpiSelect_DisconnectHandler_t)(void *);
...
typedef enum
{
    MANGOH_GPIOPINSPISELECT_ACTIVE_HIGH = 0,
        ///< GPIO active-high, output is 1
    MANGOH_GPIOPINSPISELECT_ACTIVE_LOW = 1
        ///< GPIO active-low, output is 0
}
mangoh_gpioPinSpiSelect_Polarity_t;
...
typedef enum
{
    MANGOH_GPIOPINSPISELECT_EDGE_NONE = 0,
        ///< No edge detection
    MANGOH_GPIOPINSPISELECT_EDGE_RISING = 1,
        ///< Notify when voltage goes from low to high.
    MANGOH_GPIOPINSPISELECT_EDGE_FALLING = 2,
        ///< Notify when voltage goes from high to low.
    MANGOH_GPIOPINSPISELECT_EDGE_BOTH = 3
        ///< Notify when pin voltage changes state in either direction.
}
mangoh_gpioPinSpiSelect_Edge_t;


//--------------------------------------------------------------------------------------------------
/**
 * Reference type used by Add/Remove functions for EVENT 'mangoh_gpioPinSpiSelect_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
typedef struct mangoh_gpioPinSpiSelect_ChangeEventHandler* mangoh_gpioPinSpiSelect_ChangeEventHandlerRef_t;
...
typedef enum
{
    MANGOH_GPIOPINSPISELECT_PULL_OFF = 0,
        ///< Neither resistor is enabled
    MANGOH_GPIOPINSPISELECT_PULL_DOWN = 1,
        ///< Pulldown resistor is enabled
    MANGOH_GPIOPINSPISELECT_PULL_UP = 2
        ///< Pullup resistor is enabled
}
mangoh_gpioPinSpiSelect_PullUpDown_t;
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*mangoh_gpioPinSpiSelect_ChangeCallbackFunc_t)
(
    bool state,
...
#endif // MANGOH_GPIOPINSPISELECT_INTERFACE_H_INCLUDE_GUARD