...
#ifndef MANGOH_GPIOPINUART1ENABLE_INTERFACE_H_INCLUDE_GUARD
#define MANGOH_GPIOPINUART1ENABLE_INTERFACE_H_INCLUDE_GUARD
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*mangoh_gpioPinUart1Enable_DisconnectHandler_t)(void *);
...
typedef enum
{
    MANGOH_GPIOPINUART1ENABLE_ACTIVE_HIGH = 0,
        ///< GPIO active-high, output is 1
    MANGOH_GPIOPINUART1ENABLE_ACTIVE_LOW = 1
        ///< GPIO active-low, output is 0
}
mangoh_gpioPinUart1Enable_Polarity_t;
...
typedef enum
{
    MANGOH_GPIOPINUART1ENABLE_EDGE_NONE = 0,
        ///< No edge detection
    MANGOH_GPIOPINUART1ENABLE_EDGE_RISING = 1,
        ///< Notify when voltage goes from low to high.
    MANGOH_GPIOPINUART1ENABLE_EDGE_FALLING = 2,
        ///< Notify when voltage goes from high to low.
    MANGOH_GPIOPINUART1ENABLE_EDGE_BOTH = 3
        ///< Notify when pin voltage changes state in either direction.
}
mangoh_gpioPinUart1Enable_Edge_t;


//--------------------------------------------------------------------------------------------------
/**
 * Reference type used by Add/Remove functions for EVENT 'mangoh_gpioPinUart1Enable_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
typedef struct mangoh_gpioPinUart1Enable_ChangeEventHandler* mangoh_gpioPinUart1Enable_ChangeEventHandlerRef_t;
...
typedef enum
{
    MANGOH_GPIOPINUART1ENABLE_PULL_OFF = 0,
        ///< Neither resistor is enabled
    MANGOH_GPIOPINUART1ENABLE_PULL_DOWN = 1,
        ///< Pulldown resistor is enabled
    MANGOH_GPIOPINUART1ENABLE_PULL_UP = 2
        ///< Pullup resistor is enabled
}
mangoh_gpioPinUart1Enable_PullUpDown_t;
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*mangoh_gpioPinUart1Enable_ChangeCallbackFunc_t)
(
    bool state,
...
#endif // MANGOH_GPIOPINUART1ENABLE_INTERFACE_H_INCLUDE_GUARD