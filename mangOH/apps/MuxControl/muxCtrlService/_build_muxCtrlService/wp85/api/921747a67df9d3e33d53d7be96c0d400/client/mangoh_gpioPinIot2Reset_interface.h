...
#ifndef MANGOH_GPIOPINIOT2RESET_INTERFACE_H_INCLUDE_GUARD
#define MANGOH_GPIOPINIOT2RESET_INTERFACE_H_INCLUDE_GUARD
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*mangoh_gpioPinIot2Reset_DisconnectHandler_t)(void *);
...
typedef enum
{
    MANGOH_GPIOPINIOT2RESET_ACTIVE_HIGH = 0,
        ///< GPIO active-high, output is 1
    MANGOH_GPIOPINIOT2RESET_ACTIVE_LOW = 1
        ///< GPIO active-low, output is 0
}
mangoh_gpioPinIot2Reset_Polarity_t;
...
typedef enum
{
    MANGOH_GPIOPINIOT2RESET_EDGE_NONE = 0,
        ///< No edge detection
    MANGOH_GPIOPINIOT2RESET_EDGE_RISING = 1,
        ///< Notify when voltage goes from low to high.
    MANGOH_GPIOPINIOT2RESET_EDGE_FALLING = 2,
        ///< Notify when voltage goes from high to low.
    MANGOH_GPIOPINIOT2RESET_EDGE_BOTH = 3
        ///< Notify when pin voltage changes state in either direction.
}
mangoh_gpioPinIot2Reset_Edge_t;


//--------------------------------------------------------------------------------------------------
/**
 * Reference type used by Add/Remove functions for EVENT 'mangoh_gpioPinIot2Reset_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
typedef struct mangoh_gpioPinIot2Reset_ChangeEventHandler* mangoh_gpioPinIot2Reset_ChangeEventHandlerRef_t;
...
typedef enum
{
    MANGOH_GPIOPINIOT2RESET_PULL_OFF = 0,
        ///< Neither resistor is enabled
    MANGOH_GPIOPINIOT2RESET_PULL_DOWN = 1,
        ///< Pulldown resistor is enabled
    MANGOH_GPIOPINIOT2RESET_PULL_UP = 2
        ///< Pullup resistor is enabled
}
mangoh_gpioPinIot2Reset_PullUpDown_t;
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*mangoh_gpioPinIot2Reset_ChangeCallbackFunc_t)
(
    bool state,
...
#endif // MANGOH_GPIOPINIOT2RESET_INTERFACE_H_INCLUDE_GUARD