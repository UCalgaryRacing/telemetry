...
#ifndef MANGOH_GPIOPINARDUINORESET_INTERFACE_H_INCLUDE_GUARD
#define MANGOH_GPIOPINARDUINORESET_INTERFACE_H_INCLUDE_GUARD
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*mangoh_gpioPinArduinoReset_DisconnectHandler_t)(void *);
...
typedef enum
{
    MANGOH_GPIOPINARDUINORESET_ACTIVE_HIGH = 0,
        ///< GPIO active-high, output is 1
    MANGOH_GPIOPINARDUINORESET_ACTIVE_LOW = 1
        ///< GPIO active-low, output is 0
}
mangoh_gpioPinArduinoReset_Polarity_t;
...
typedef enum
{
    MANGOH_GPIOPINARDUINORESET_EDGE_NONE = 0,
        ///< No edge detection
    MANGOH_GPIOPINARDUINORESET_EDGE_RISING = 1,
        ///< Notify when voltage goes from low to high.
    MANGOH_GPIOPINARDUINORESET_EDGE_FALLING = 2,
        ///< Notify when voltage goes from high to low.
    MANGOH_GPIOPINARDUINORESET_EDGE_BOTH = 3
        ///< Notify when pin voltage changes state in either direction.
}
mangoh_gpioPinArduinoReset_Edge_t;


//--------------------------------------------------------------------------------------------------
/**
 * Reference type used by Add/Remove functions for EVENT 'mangoh_gpioPinArduinoReset_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
typedef struct mangoh_gpioPinArduinoReset_ChangeEventHandler* mangoh_gpioPinArduinoReset_ChangeEventHandlerRef_t;
...
typedef enum
{
    MANGOH_GPIOPINARDUINORESET_PULL_OFF = 0,
        ///< Neither resistor is enabled
    MANGOH_GPIOPINARDUINORESET_PULL_DOWN = 1,
        ///< Pulldown resistor is enabled
    MANGOH_GPIOPINARDUINORESET_PULL_UP = 2
        ///< Pullup resistor is enabled
}
mangoh_gpioPinArduinoReset_PullUpDown_t;
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*mangoh_gpioPinArduinoReset_ChangeCallbackFunc_t)
(
    bool state,
...
#endif // MANGOH_GPIOPINARDUINORESET_INTERFACE_H_INCLUDE_GUARD