...
#ifndef MANGOH_GPIOPINSDIOSELECT_INTERFACE_H_INCLUDE_GUARD
#define MANGOH_GPIOPINSDIOSELECT_INTERFACE_H_INCLUDE_GUARD
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*mangoh_gpioPinSdioSelect_DisconnectHandler_t)(void *);
...
typedef enum
{
    MANGOH_GPIOPINSDIOSELECT_ACTIVE_HIGH = 0,
        ///< GPIO active-high, output is 1
    MANGOH_GPIOPINSDIOSELECT_ACTIVE_LOW = 1
        ///< GPIO active-low, output is 0
}
mangoh_gpioPinSdioSelect_Polarity_t;
...
typedef enum
{
    MANGOH_GPIOPINSDIOSELECT_EDGE_NONE = 0,
        ///< No edge detection
    MANGOH_GPIOPINSDIOSELECT_EDGE_RISING = 1,
        ///< Notify when voltage goes from low to high.
    MANGOH_GPIOPINSDIOSELECT_EDGE_FALLING = 2,
        ///< Notify when voltage goes from high to low.
    MANGOH_GPIOPINSDIOSELECT_EDGE_BOTH = 3
        ///< Notify when pin voltage changes state in either direction.
}
mangoh_gpioPinSdioSelect_Edge_t;


//--------------------------------------------------------------------------------------------------
/**
 * Reference type used by Add/Remove functions for EVENT 'mangoh_gpioPinSdioSelect_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
typedef struct mangoh_gpioPinSdioSelect_ChangeEventHandler* mangoh_gpioPinSdioSelect_ChangeEventHandlerRef_t;
...
typedef enum
{
    MANGOH_GPIOPINSDIOSELECT_PULL_OFF = 0,
        ///< Neither resistor is enabled
    MANGOH_GPIOPINSDIOSELECT_PULL_DOWN = 1,
        ///< Pulldown resistor is enabled
    MANGOH_GPIOPINSDIOSELECT_PULL_UP = 2
        ///< Pullup resistor is enabled
}
mangoh_gpioPinSdioSelect_PullUpDown_t;
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*mangoh_gpioPinSdioSelect_ChangeCallbackFunc_t)
(
    bool state,
...
#endif // MANGOH_GPIOPINSDIOSELECT_INTERFACE_H_INCLUDE_GUARD