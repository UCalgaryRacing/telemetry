...
#include "mangoh_gpioPinUart1Enable_interface.h"
#include "mangoh_gpioPinUart1Enable_messages.h"
...
typedef struct
{
    ...
    mangoh_gpioPinUart1Enable_DisconnectHandler_t disconnectHandler; ///< Disconnect handler for this thread
...
)
{
    ...
    LE_FATAL_IF(clientThreadPtr==NULL,
                "mangoh_gpioPinUart1Enable_ConnectService() not called for current thread");
...
static void InitCommonData(void)
{
    ...
    _ClientDataPool = le_mem_CreatePool("mangoh_gpioPinUart1Enable_ClientData", sizeof(_ClientData_t));

    // Allocate the client thread pool
    _ClientThreadDataPool = le_mem_CreatePool("mangoh_gpioPinUart1Enable_ClientThreadData", sizeof(_ClientThreadData_t));
    ...
    _HandlerRefMap = le_ref_CreateMap("mangoh_gpioPinUart1Enable_ClientHandlers", 5);
}
 ...
 */
//--------------------------------------------------------------------------------------------------
void mangoh_gpioPinUart1Enable_ConnectService
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t mangoh_gpioPinUart1Enable_TryConnectService
(
    void
)
{
...
)
{
    ...
    LE_FATAL("Component for mangoh_gpioPinUart1Enable disconnected\n");
}
 ...
 */
//--------------------------------------------------------------------------------------------------
void mangoh_gpioPinUart1Enable_SetServerDisconnectHandler
(
    mangoh_gpioPinUart1Enable_DisconnectHandler_t disconnectHandler,
    void *contextPtr
)
{
    _ClientThreadData_t* clientThreadPtr = GetClientThreadDataPtr();
 ...
 */
//--------------------------------------------------------------------------------------------------
void mangoh_gpioPinUart1Enable_DisconnectService
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t mangoh_gpioPinUart1Enable_SetInput
(
    mangoh_gpioPinUart1Enable_Polarity_t polarity
...
)
{
    ...
    _msgPtr->id = _MSGID_mangoh_gpioPinUart1Enable_SetInput;
    ...
    LE_ASSERT(mangoh_gpioPinUart1Enable_PackPolarity( &_msgBufPtr, &_msgBufSize,
                                                  polarity ));
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t mangoh_gpioPinUart1Enable_SetPushPullOutput
(
    mangoh_gpioPinUart1Enable_Polarity_t polarity,
        ///< [IN] Active-high or active-low.
    bool value
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinUart1Enable_SetPushPullOutput;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t mangoh_gpioPinUart1Enable_SetTriStateOutput
(
    mangoh_gpioPinUart1Enable_Polarity_t polarity
        ///< [IN] Active-high or active-low.
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinUart1Enable_SetTriStateOutput;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t mangoh_gpioPinUart1Enable_SetOpenDrainOutput
(
    mangoh_gpioPinUart1Enable_Polarity_t polarity,
        ///< [IN] Active-high or active-low.
    bool value
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinUart1Enable_SetOpenDrainOutput;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t mangoh_gpioPinUart1Enable_EnablePullUp
(
    void
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinUart1Enable_EnablePullUp;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t mangoh_gpioPinUart1Enable_EnablePullDown
(
    void
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinUart1Enable_EnablePullDown;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t mangoh_gpioPinUart1Enable_DisableResistors
(
    void
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinUart1Enable_DisableResistors;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t mangoh_gpioPinUart1Enable_Activate
(
    void
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinUart1Enable_Activate;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t mangoh_gpioPinUart1Enable_Deactivate
(
    void
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinUart1Enable_Deactivate;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t mangoh_gpioPinUart1Enable_SetHighZ
(
    void
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinUart1Enable_SetHighZ;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
 ...
 */
//--------------------------------------------------------------------------------------------------
bool mangoh_gpioPinUart1Enable_Read
(
    void
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinUart1Enable_Read;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
...
static void _Handle_mangoh_gpioPinUart1Enable_AddChangeEventHandler
(
    void* _reportPtr,
    void* _dataPtr
)
{
    ...
    mangoh_gpioPinUart1Enable_ChangeCallbackFunc_t _handlerRef_mangoh_gpioPinUart1Enable_AddChangeEventHandler = (mangoh_gpioPinUart1Enable_ChangeCallbackFunc_t)_clientDataPtr->handlerPtr;
    ...
    if ( _handlerRef_mangoh_gpioPinUart1Enable_AddChangeEventHandler != NULL )
    {
        _handlerRef_mangoh_gpioPinUart1Enable_AddChangeEventHandler(state, contextPtr );
    }
    else
    {
...
//--------------------------------------------------------------------------------------------------
/**
 * Add handler function for EVENT 'mangoh_gpioPinUart1Enable_ChangeEvent'
 *
 ...
 */
//--------------------------------------------------------------------------------------------------
mangoh_gpioPinUart1Enable_ChangeEventHandlerRef_t mangoh_gpioPinUart1Enable_AddChangeEventHandler
(
    mangoh_gpioPinUart1Enable_Edge_t trigger,
        ///< [IN] Change(s) that should trigger the callback to be called.
    mangoh_gpioPinUart1Enable_ChangeCallbackFunc_t handlerPtr,
...
)
{
    ...
    mangoh_gpioPinUart1Enable_ChangeEventHandlerRef_t _result;
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinUart1Enable_AddChangeEventHandler;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
    ...
    // Pack the input parameters
    LE_ASSERT(mangoh_gpioPinUart1Enable_PackEdge( &_msgBufPtr, &_msgBufSize,
                                                  trigger ));
...
//--------------------------------------------------------------------------------------------------
/**
 * Remove handler function for EVENT 'mangoh_gpioPinUart1Enable_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
void mangoh_gpioPinUart1Enable_RemoveChangeEventHandler
(
    mangoh_gpioPinUart1Enable_ChangeEventHandlerRef_t handlerRef
        ///< [IN]
)
{
    le_msg_MessageRef_t _msgRef;
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinUart1Enable_RemoveChangeEventHandler;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
    ...
    _UNLOCK
    handlerRef = (mangoh_gpioPinUart1Enable_ChangeEventHandlerRef_t)clientDataPtr->handlerRef;
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t mangoh_gpioPinUart1Enable_SetEdgeSense
(
    mangoh_gpioPinUart1Enable_Edge_t trigger
        ///< [IN] Change(s) that should trigger the callback to be called.
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinUart1Enable_SetEdgeSense;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t mangoh_gpioPinUart1Enable_DisableEdgeSense
(
    void
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinUart1Enable_DisableEdgeSense;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
 ...
 */
//--------------------------------------------------------------------------------------------------
bool mangoh_gpioPinUart1Enable_IsOutput
(
    void
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinUart1Enable_IsOutput;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
 ...
 */
//--------------------------------------------------------------------------------------------------
bool mangoh_gpioPinUart1Enable_IsInput
(
    void
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinUart1Enable_IsInput;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
 ...
 */
//--------------------------------------------------------------------------------------------------
mangoh_gpioPinUart1Enable_Edge_t mangoh_gpioPinUart1Enable_GetEdgeSense
(
    void
)
{
    ...
    mangoh_gpioPinUart1Enable_Edge_t _result;
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinUart1Enable_GetEdgeSense;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
    ...
    // Unpack the result first
    if (!mangoh_gpioPinUart1Enable_UnpackEdge( &_msgBufPtr, &_msgBufSize, &_result ))
    {
        goto error_unpack;
    }
 ...
 */
//--------------------------------------------------------------------------------------------------
mangoh_gpioPinUart1Enable_Polarity_t mangoh_gpioPinUart1Enable_GetPolarity
(
    void
)
{
    ...
    mangoh_gpioPinUart1Enable_Polarity_t _result;
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinUart1Enable_GetPolarity;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
    ...
    // Unpack the result first
    if (!mangoh_gpioPinUart1Enable_UnpackPolarity( &_msgBufPtr, &_msgBufSize, &_result ))
    {
        goto error_unpack;
    }
 ...
 */
//--------------------------------------------------------------------------------------------------
bool mangoh_gpioPinUart1Enable_IsActive
(
    void
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinUart1Enable_IsActive;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
 ...
 */
//--------------------------------------------------------------------------------------------------
mangoh_gpioPinUart1Enable_PullUpDown_t mangoh_gpioPinUart1Enable_GetPullUpDown
(
    void
)
{
    ...
    mangoh_gpioPinUart1Enable_PullUpDown_t _result;
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_mangoh_gpioPinUart1Enable_GetPullUpDown;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
    ...
    // Unpack the result first
    if (!mangoh_gpioPinUart1Enable_UnpackPullUpDown( &_msgBufPtr, &_msgBufSize, &_result ))
    {
        goto error_unpack;
    }
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_mangoh_gpioPinUart1Enable_AddChangeEventHandler :
            le_event_QueueFunctionToThread(callersThreadRef, _Handle_mangoh_gpioPinUart1Enable_AddChangeEventHandler, msgRef, clientDataPtr);
            break;
